...
<GridContainer>
  <HeroImage />
  <SideBySide className="mt-2 mb-20 sm:mt-14">
    ...
    <TextBlock className="flex-[3]">The word "Toloka" stands for a traditional form of solidarity support in Ukraine. 
      ...
      Various partners work together in different projects like **reconstruction & renovation, open production, knowledge transfer and innovation** to strenghten the community of Ukraine.</TextBlock>
  </SideBySide>
</GridContainer>

<ContentSection fullBleed id="news" className="bg-neutral-50">
  <NewsSlider headline="News" /> 
</ContentSection>

<GridContainer id="what-is-a-tolocar">
  <ContentSection variant="white">
    <HeadlineUnderlined large variant={6} className="mt-8 sm:mt-20">What is a Tolocar?</HeadlineUnderlined>
    <div class="flex lg:justify-start mt-8 sm:mt-16 mb-8">
...
<GridContainer className="bg-neutral-800">
  <ContentSection>
    {/* <div className="bg-white absolute w-full h-40 top-0"/>  */}
    <div class="flex lg:justify-end bg-illustration-2-dark bg-no-repeat lg:bg-[position:left_0_top_135px]"> 
...
<GridContainer>
  <ContentSection id="what-we-do">
    <HeadlineUnderlined large variant={8} className="mt-8 sm:mt-20">What we do</HeadlineUnderlined>
    <div class="flex lg:justify-start mt-8 sm:mt-14 mb-16">
...
<GridContainer className="bg-neutral-800">
  <ContentSection variant="dark" className="z-10">
    <div class="flex flex-col lg:flex-row gap-6 -mt-20 pb-8">
